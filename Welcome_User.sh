...
# randomly display a nice message or quote or xkcd comic or joke or news
...
then
    case $ch in
        ...
        ;;
        2) echo "Don't let insecurity ruin the beauty you were born with."
        ;;
        3) echo "Shoot for the moon. Even if you miss, you will land among the stars."
        ;;
        4) echo "Your value doesn't decrease based on someone's inablility to see your worth."
        ;;
        5) echo "If you can dream it, you can do it."
        ;;
        6) echo "Don't let the opinions of others define you."
        ;;
